...
## Figuras (curvas train/val)
- Loss/val_loss por experimento: ver carpeta `experiments/plots/`
- val_success por experimento: ver carpeta `experiments/plots/`

Sugerencia para memoria (mínimo):
- Elegir 1 figura de *loss* y 1 figura de *val_success* del experimento ganador.
